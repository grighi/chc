...
I find that the establishment of a CMHC in a county reduced age-adjusted mortality among 20-49 year olds by approximately 10-12 deaths per 100,000 within a decade, which is a substantial effect given baseline mortality in this age group. The effect is robust to controlling for the concurrent rollout of Community Health Centers, whose mortality effects operated through primary care for older Americans (Bailey and Goodman-Bacon 2015). There is no effect among those aged 50 and older, consistent with CMHCs operating through mental health channels rather than cardiovascular and chronic disease channels more relevant to older adults. In a cause of death decomposition, I find that the effects are driven by reductions in external causes of death, especially homicides.
...
\subsection{First Era: Community Mental Health Centers (1963-1981)}
...
\subsection{Second Era: Community Behavioral Health Centers (2014-Present)}

A second era of federal investment in community mental health was initiated by federal legislation in 2014, overlapping with the era when several literatures were increasingly becoming aware of ``deaths of despair'' (citex Deaton 2023). This created the Certified Community Behavioral Health Center (CCBHC) demonstration program. Rather than providing seed money for construction, the Act permitted CCBHCs to receive funding through the Medicaid PPS, mirroring the federal funding model that has stabilized FQHCs.  They also added additional treatment requirements, including 24/7 crisis services and medication for opioid use disorder. The initial demonstration program began in 2017 with eight states, and subsequent expansions involved counties applying for funding directly from the Substance Abuse and Mental Health Services Agency (SAMHSA).

\subsection{Existing Work on Community Mental Health Facilities}

An extensive and contested literature examines the relationship between the deinstitutionalization of individuals with serious mental illness (SMI) and the contemporaneous rise in incarceration and homelessness in the United States, a hypothesis often termed "transinstitutionalization." On one side, Penrose (citex 1939) first posited an inverse relationship between psychiatric hospital and prison populations, and more recently Torrey et al. (citex 2010, 2014) have argued forcefully that the emptying of state hospitals without adequate community alternatives led directly to the criminalization of mental illness and a massive shift of individuals with SMI into jails and prisons. Bronson and Berzofsky (citex) find that in 2012, people with SMI made up 26\% of people in local jails. 

\hl{Add cites to Lamb and Weinberger}

Many authors have challenged this tight causal interpretation. Raphael and Stoll (citex 2001) have shown that while deinstitutionalization contributed to the rise in incarceration, it was not the sole or primary driver. (citex Culhane et al. 2002) argues that these trends are better explained by poverty, lack of education, joblessness, and substance use, rather than by the discharge of psychiatric patients per se. In their analysis, populations affected by deinstitutionalization and mass incarceration overlap less than the psychiatric framework implies, and the response requires more than increasing psychiatric hospital capacity. The empirical evidence remains mixed, and disentangling the causal effect of deinstitutionalization from the many concurrent policy shifts of the late twentieth century has proven difficult.

This paper sidesteps the broader transinstitutionalization debate and instead examines a more targeted policy question: what are the long-run effects of community mental health centers (CMHCs) themselves? Regardless of one's priors on the Penrose hypothesis, CMHCs represent a concrete, federally initiated intervention whose rollout generates plausibly exogenous variation in the availability of community-based mental health treatment. Understanding their effects is of independent interest because CMHCs were not merely a residual of hospital closures but were designed as a positive investment in outpatient infrastructure. Today they frequently serve as the institutional foundation from which more intensive programs such as Assertive Community Treatment (ACT), Assisted Outpatient Treatment (AOT), and other intervention models have been developed and scaled. These programs, in turn, sit at the center of contemporary debates over civil commitment reform. By estimating the causal effects of CMHCs on downstream outcomes including incarceration, this paper offers evidence on what community-based treatment capacity can accomplish on its own terms, independent of the unresolved questions surrounding deinstitutionalization and civil commitment.
...
\section{Estimates of the Relationship Between CMHCs and Life Outcomes}

This section first shows that CMHCs had a substantial impact on mortality among working-age adults, but not among the elderly. I verify that these effects are robust to controlling for the concurrent rollout of Community Health Centers. I then use cause-of-death decompositions to show that the effects are driven by reductions in external causes (homicide, suicide, overdose), which is consistent with the mental health channels through which CMHCs were designed to operate. I compare my estimates to those in Avery and LaVoice (citex 2023) and show that the differences in estimates are driven by my use of state-by-year fixed effects rather than state linear trends, which have the risk of absorbing some of the treatment effect and pre-trends. I then turn to later life outcomes, including earnings and disability, finding evidence that people who were young during the expansion of these centers experienced protective effects decades later.
...
Figure \ref{fig:cmhc_es} plots event-study estimates from the baseline specification which includes state-year fixed effects ($\delta_{s(j)t}$) and county ($X_jt$) covariates. The panel on the left shows estimates for adults ages 20-49, on the right for adults ages 50+. \textbt{\emph{The line with dots shows the Sun and Abraham (2021) estimates, which here is the baseline specification. The shaded area shows the 95\% confidence interval for the Sun and Abraham (2021) estimates. The line with triangles shows the standard two-way fixed effects estimates. The line with open circles shows the two-way fixed effects estimates without state-year fixed effects, which is the specification used in Avery and LaVoice (2023). The line with squares shows the baseline specification with controls for the concurrent rollout of Community Health Centers.}}

Across specifications for younger adults there is no evidence for differential trends in mortality in treated counties before the CMHC program began. As in Bailey and Goodman Bacon (2015), this implies that the structure of fixed effects and trends captures the generally declining AMR during this time period. Pre-treatment coefficients are flat and close to zero, supporting the notion that the timing of CMHC establishment is not correlated with pre-existing trends in mortality. After treatment, there is a gradual decline in mortality that reaches approximately -10 to -12 per 100,000 by event year +10. This is a substantial effect given baseline mortality in this age group. 

The event study for older adults provides a placebo test for the main effects, since mortality in this age group is  more driven by chronic disease than it is for younger adults. Coefficients for years prior to center construction suggest that centers were constructed in areas where mortality for older adults was declining faster. This is consistent with the notion centers were not targeted to areas with high mental health mortality but rather to areas with more resources and better healthcare infrastructure. Coefficient after treatment are flat with wide standard errors. This rules out that the results for younger adults are driven by a general improvement in healthcare infrastructure.

The Sun and Abraham (2021) decomposition gives a straightforward comparison between areas that received centers earlier and later, suggesting that the effects were strongest for earlier cohorts. This is consistent with \emph{\textbf{the reduction in funding that occurred after 1975 (Check Grob for 1975 funding clawback details and citex).}} Table \ref{tab:cmhc_sunab} shows the treatment effects and characteristics of counties that received centers by cohort.

% Add paragraph about comparison between urban and rural. 

There is a partial rebound in the far-right tail (years 15+), which corresponds to the 1981 block-grant conversion for later-adopting CMHCs. This rebound is consistent with the funding withdrawal story and is itself informative about the role of sustained investment.

\input{../build/output/tables/table02_dd_robustness.tex}

Estimates are fairly consistent across a set of different specifications that verify the robustness of the results. Table \ref{tab:robustness} summarizes the event study estimates across time bins for several specifications. Specifications are listed along the rows, and time bins are listed along the columns. Row (1) shows estimates from a specification with county fixed effects $\theta_j$ and urban quintile by year fixed effects $\gamma_{u(j)t}$. This is the two-way fixed effects analogue of the specification used in Avery and LaVoice (2023). Row (2) adds state-year fixed effects $\delta_{s(j)t}$, reflecting the baseline specification. Row (3) adds county covariates and time trends based on the covariates from the 1960 Census row (4) adds county-specific linear time trends $\theta_j t$ rather than time trends on controls for county characteristics. Row (5) adds controls for Community Health Center rollout. Row (6) includes propensity score reweighting of the control group to balance the characteristics of treated and untreated counties in Table 1.

% BGB:45. "The robustness of the estimates in the reweighted sample is particularly helpful, as comparisons between treated and untreated counties are made in the region of common support."
...
\subsection{Results for Cause-Specific Age Adjusted Mortality Rates}

\input{../build/output/tables/table03_cause_decomp_cmhc.tex}

Decomposing all-cause mortality effects by cause of death sheds light on the mechanisms through which CMHCs operated. Table \ref{tab:cause_decomp} shows the event study estimates binned across years for different causes of death. The first row shows the all-cause mortality effects, which are consistent with the event study estimates in Figure \ref{fig:cmhc_es}. The rest of Panel A decomposes the all-cause effect into various causes. Internal causes (Cardiovascular, Cerebrovascular, Cancer, Infectious Disease, Diabetes) consistently show no significant effects of opening a mental health center. Panel B repeats this decomposition with public NBER Multiple Cause of Death mortality data to verify that the results are consistent across data sources. The final row of Panel B includes all other causes of death. The first row of Panel C then shows that these other causes are dominated by external causes of death. The rest of Panel C adds and decomposes these external causes, which include suicides, homicides, drug overdoses, and accidents. Panel D turns to a race-specific decomposition of external causes.

\hl{Verify the results in the NBER data here.}

Similar to Avery and LaVoice (2023), I find that the results on all-cause mortality are concentrated in external causes of death, which include suicides, homicides, drug overdoses, and accidents. These are the causes most directly linked to mental illness and its treatment. The finding that effects extend beyond the narrow set of causes examined by Avery and LaVoice (2023) explains why all-cause effects are larger than the sum of their cause-specific estimates. One of the challenges for interpreting those estimates is that they find significant effects primarily when pooling together the years after center construction. Their event study estimates for individual years are noisy and often not significant. \emph{\textbf{By contrast, my specification with state-year fixed effects produces more precise estimates that show significant effects in individual years after center construction.}} I find flat pretrends and coefficients that monotonically decline after center construction. I also find in a specification that adds county-specific time trends that the declines in homicide after center opening are significant for both white and non-white populations.
...
\subsection{Results on Other Life Outcomes}

Next I examine is the impact of CMHC establishment on incarceration and find some evidence that they reduced local jail populations. Data on this is sparse, and so I am only able to estimate a simple long difference specification comparing the change in jail population from 1970 to 1980 in counties that received CMHCs by 1975 to the change in counties that did not receive CMHCs by 1975. Table \ref{tab:longdiff} shows the results. \hl{The point estimate in A means B.} I find that counties that received CMHCs experienced a \hl{10\%} reduction in local jail populations relative to counties that did not receive CMHCs. This is consistent with the finding in other sections that CMHCs reduced homicide mortality.

Since the best evidence of impacts is on working-age adults, I examine the impacts on long-term outcomes for children who were young during the expansion of CMHCs. 

\subsection{Replication of Avery and LaVoice (2023)}

\hl{complete this.}

\section{Estimates of the Relationship Between CCBHCs and Life Outcomes}

Turning to the contemporary era, I show evidence that CCBHCs have had similar impacts on incarceration and mortality. I also show evidence that CCBHCs reduced local jail populations, and that they had a protective effect against COVID-19 era rise in mortality due to deaths of despair. 

\subsection{Evidence of the Relationship Between CCBHCs and Mortality}
...
\subsection{Evidence of the Relationship Between CCBHCs and Incarceration}


\section{The Longer-Term Returns to Community Mental Health}
...
\item Running age-adjusted NBER mortality decomp on server (will this be better than 15b?)
\end{itemize}
